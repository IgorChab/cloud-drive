...
export const ShareFile = () => {
    ...
    const getShareFile = (id: string | undefined) => {
        axios.get<ShareFileResponse>(`http://localhost:5000/files/shareFiles/${link}`).then(res => {
    ...
    const getCurrentFolder = (folder: File) => {
        ...
        axios.get<File>(`http://localhost:5000/files/getCurrentFolder/${folder._id}`).then(res => {
                ...
                <div className='font-medium text-lg w-full p-[15px_20px] border-b border-b-slate-400 flex justify-between items-center'>
                    ...
                    <div className='flex items-center'>
                        <Button color='primary'>
                            <a 
                                href={`http://localhost:5000/files/downloadFolder/${currentFolder?._id}`} 
                                download
                            >
                                Download all
                            </a>
